...
- [x] **Phase 1: Scaffold and Foundations** - Project scaffolding, database schema, auth config, and never-retrofit decisions
- [x] **Phase 2: Authentication and Onboarding** - Users can create accounts, log in, and complete minimal onboarding
- [x] **Phase 3: Plant Collection and Rooms** - Users can manage a plant collection, use catalog presets, and organize by room
- [x] **Phase 4: Dashboard and Watering Core Loop** - Users can see which plants need care today and log watering in one tap
- [x] **Phase 5: Notes, Search, and Filters** - Users can annotate plants and find any plant quickly
- [x] **Phase 6: Reminders and Demo Mode** - Users get in-app reminders; visitors can explore without signing up
