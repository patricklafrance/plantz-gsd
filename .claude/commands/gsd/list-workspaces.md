...
<execution_context>
@c:/Dev/poc/plantz-gsd/.claude/get-shit-done/workflows/list-workspaces.md
@c:/Dev/poc/plantz-gsd/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @c:/Dev/poc/plantz-gsd/.claude/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
