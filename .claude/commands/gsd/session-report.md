...
<execution_context>
@c:/Dev/poc/plantz-gsd/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @c:/Dev/poc/plantz-gsd/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
