...
Reference full template: `c:/Dev/poc/plantz-gsd/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `c:/Dev/poc/plantz-gsd/.claude/get-shit-done/templates/state.md`.
