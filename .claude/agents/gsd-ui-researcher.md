...
Use template from `c:/Dev/poc/plantz-gsd/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `c:/Dev/poc/plantz-gsd/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "c:/Dev/poc/plantz-gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
