...
<reference>
@c:/Dev/poc/plantz-gsd/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `c:/Dev/poc/plantz-gsd/.claude/get-shit-done/references/user-profiling.md` to load:
