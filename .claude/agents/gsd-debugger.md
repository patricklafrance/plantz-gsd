...
<required_reading>
@C:/Dev/poc/plantz-gsd/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Dev/poc/plantz-gsd/.claude
                  → checks C:/Dev/poc/plantz-gsd/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Dev/poc/plantz-gsd/.claude/get-shit-done
                  → writes to C:/Dev/poc/plantz-gsd/.claude/get-shit-done/hooks/
...
@C:/Dev/poc/plantz-gsd/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Dev/poc/plantz-gsd/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/Dev/poc/plantz-gsd/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Dev/poc/plantz-gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Dev/poc/plantz-gsd/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
