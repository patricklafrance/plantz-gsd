...
<!-- For checkpoint task examples and patterns, see @C:/Dev/poc/plantz-gsd/.claude/get-shit-done/references/checkpoints.md -->
...
See `C:/Dev/poc/plantz-gsd/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Dev/poc/plantz-gsd/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Dev/poc/plantz-gsd/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
