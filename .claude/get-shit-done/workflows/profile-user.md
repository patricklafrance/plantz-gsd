...
```bash
cp "C:/Dev/poc/plantz-gsd/.claude/get-shit-done/USER-PROFILE.md" "C:/Dev/poc/plantz-gsd/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="C:/Dev/poc/plantz-gsd/.claude/USER-PROFILE.backup.md"
```
