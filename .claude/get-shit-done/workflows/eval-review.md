...
```bash
AUDITOR_MODEL=$(node "C:/Dev/poc/plantz-gsd/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/Dev/poc/plantz-gsd/.claude/agents/gsd-eval-auditor.md for instructions.
